                    ...
                    <div className="container wishup-box">
                        <div className="row">
                            ...
                            <div className="col-md-3">
                                ...
                                <div className="what-we-do-card">
                                    <div className="icon-box">
                                        <img src='/static/assets/resources/icons/Add document.svg' height="50px"/>
                                    </div>
                            ...
                            <div className="col-md-3">
                                ...
                                <div className="what-we-do-card">
                                    <div className="icon-box">
                                        <img src='/static/assets/resources/icons/socialmedia.svg' height="50px"/>
                                    </div>
                                    <div className="task-title">
                            ...
                            <div className="col-md-3">
                                <div className="what-we-do-card">
                                    <div className="icon-box">
                                        <img src='/static/assets/resources/icons/lead.svg' height="50px"/>
                                    </div>
                                    <div className="task-title">
                            ...
                            <div className="col-md-3">
                                ...
                                <div className="what-we-do-card">
                                    <div className="icon-box">
                                        <img src='/static/assets/resources/icons/research.svg' height="50px"/>
                                    </div>
                                    <div className="task-title">
                                        Research Assistant
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-3">
                                <a href="/hire-bookkeeping-assistant">
                                    <div className="what-we-do-card">
                                        <div className="icon-box">
                                            <img src='/static/assets/resources/icons/bookkeeping.svg' height="50px"/>
                                        </div>
                                        <div className="task-title">
                            ...
                            <div className="col-md-3">
                                ...
                                <div className="what-we-do-card">
                                    <div className="icon-box">
                                        <img src='/static/assets/resources/icons/mail.svg' height="50px"/>
                                    </div>
                                    <div className="task-title">
                                        Email Assistant
                                    </div>
                            ...
                            <div className="col-md-3">
                                ...
                                <div className="what-we-do-card">
                                    <div className="icon-box">
                                        <img src='/static/assets/resources/icons/hiring.svg' height="50px"/>
                                    </div>
                                    <div className="task-title">
                                        Hiring Assistant
                                    </div>
                            ...
                            <div className="col-md-3">
                                <div className="what-we-do-card">
                                    <div className="icon-box">
                                        <img src='/static/assets/resources/icons/realestate.svg' height="50px"/>
                                    </div>
                                    <div className="task-title">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3 col-sm-offset-5">
                                ...
                                <div className="what-we-do-card">
                                    <div className="icon-box">
                                        <img src='/static/assets/resources/icons/travel.svg' height="50px"/>
                                    </div>
                                    <div className="task-title">
                                        Travel Assistant
                                    </div>
                    ...
                    <div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3">
                                <div className="wishup-dont-tasks">
                                    <div className="dont-do-icon-box">
                                        <img src='/static/assets/resources/icons/sales.svg' height="50px"/>
                                    </div>
                                    <div className="task-title">
                                        Sales
                                    </div>
                            ...
                            <div className="col-md-3">
                                <div className="wishup-dont-tasks">
                                    <div className="dont-do-icon-box">
                                        <img src='/static/assets/resources/icons/customersupport.svg' height="50px"/>
                                    </div>
                                    <div className="task-title">
                        ...
                        <div className="row">
                            <div className="col-md-3 col-sm-offset-3">
                                <div className="wishup-dont-tasks">
                                    <div className="dont-do-icon-box">
                                        <img src='/static/assets/resources/icons/money.svg' height="50px"/>
                                    </div>
                                    <div className="task-title">
                            ...
                            <div className="col-md-3">
                                <div className="wishup-dont-tasks">
                                    <div className="dont-do-icon-box">
                                        <img src='/static/assets/resources/icons/user.svg' height="50px"/>
                                    </div>
                                    <div className="task-title">
